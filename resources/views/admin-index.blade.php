...
<head>
    ...
    <script src="{{ asset('asset/vendor/js/helpers.js')
     }}"></script>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('beranda') }}" class="app-brand-link d-flex align-items-center">
                        <img src="{{ asset('asset/img/lg_kota_surabaya.png') }}" alt="logo" style="width: 35px; height: 35px; margin-right: 10px;">
                        <h3 class="mb-0">SiPemuda</h3>
                    </a>
                </div>
                ...
                <ul class="menu-inner py-1">
                    ...
                    {{-- <li class="menu-item {{ request()->routeIs('admin.tour.*') ? 'active open' : '' }}">
                        <a href="{{ route('admin.tour.index') }}" class="menu-link">
                            ...
                            <div data-i18n="Tours">Data Kegiatan Aktif</div>
                        </a>
                    </li> --}}
                </ul>
            </aside>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">{{ $total_peserta }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <h5 class="card-title">Total Kegiatan Aktif</h5>
                                        <p class="card-text">{{ $kegiatan_aktif }}</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Total Hadir -->
<div class="col-md-6 col-lg-4">
    <div class="card mb-4">
        <div class="card-body">
            <h5 class="card-title">Peserta Hadir</h5>
            <p class="card-text">{{ $total_hadir }}</p>
        </div>
    </div>
</div>
...
<div class="col-md-6 col-lg-4">
    <div class="card mb-4">
        <div class="card-body">
            <h5 class="card-title">Peserta Belum Hadir</h5>
            <p class="card-text">{{ $total_belum_hadir }}</p>
        </div>
    </div>
</div>
...
<div class="col-md-6 col-lg-4">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <p class="card-text">{{ $persentase_hadir }}%</p>
        </div>
    </div>
</div>
