...
<head>
    ...
    <title>Tambah Sub Kegiatan</title>
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Tambah Sub Kegiatan</h4>

                        <!-- Basic Forms -->
                        <div class="card">
                            <h5 class="card-header">Tambah Sub Kegiatan</h5>
                            <div class="card-body">
                                <form action="{{ route('admin.subKegiatan.store') }}" method="POST">
    @csrf
    <div class="mb-3">
        <label for="kode_subKegiatan" class="form-label">Kode Sub Kegiatan</label>
        <input type="text" class="form-control" id="kode_subKegiatan" name="kode_subKegiatan" required>
    </div>

    <div class="mb-3">
        <label for="nama_subKegiatan" class="form-label">Nama Sub Kegiatan</label>
        <input type="text" class="form-control" id="nama_subKegiatan" name="nama_subKegiatan" required>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="tanggal_subKegiatan" class="form-label">Tanggal</label>
            <input type="date" class="form-control" id="tanggal_subKegiatan" name="tanggal_subKegiatan" required>
        </div>
        <div class="col-md-3 mb-3">
            <label for="jam_mulai_subKegiatan" class="form-label">Jam Mulai</label>
            <input type="time" class="form-control" id="jam_mulai_subKegiatan" name="jam_mulai_sub" required>
        </div>
        <div class="col-md-3 mb-3">
            <label for="jam_selesai_subKegiatan" class="form-label">Jam Selesai</label>
            <input type="time" class="form-control" id="jam_selesai_subKegiatan" name="jam_selesai_sub" required>
        </div>
    </div>

    <div class="mb-3">
        <label for="deskripsi_subKegiatan" class="form-label">Deskripsi</label>
        <textarea class="form-control" id="deskripsi_subKegiatan" name="deskripsi_subKegiatan" rows="3"></textarea>
    </div>

    <div class="mb-3">
        <label for="status_subKegiatan" class="form-label">Status</label>
        <select name="status_subKegiatan" id="status_subKegiatan" class="form-control">
