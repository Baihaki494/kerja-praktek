...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Tambah Peserta</h4>
    ...
    <div class="mb-3">
        ...
        <select name="subKegiatan_id" class="form-control" required>
            ...
            @foreach($subKegiatan as $item)
                <option value="{{ $item->id }}">{{ $item->nama_subKegiatan }}</option>
            @endforeach
        </select>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="no_kk" class="form-control" value="{{ old('no_kk') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 16);"
       required>
        @error('no_kk')
             <small class="text-danger">{{ $message }}</small>
        @enderror  
    ...
    <div class="mb-3">
        ...
        <textarea name="kecamatan" class="form-control" rows="3" required></textarea>
    </div>

    <div class="mb-3">
        <label class="form-label">Kelurahan</label>
        <textarea name="kelurahan" class="form-control" rows="3" required></textarea>
    </div>
