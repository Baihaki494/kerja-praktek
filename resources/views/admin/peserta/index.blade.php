            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Peserta</h4>
...
<form method="GET" action="{{ route('admin.peserta.index') }}" class="mb-3 d-flex justify-content-between align-items-center">

  <div class="d-flex align-items-center">
    <input type="text" name="search" value="{{ request('search') }}" 
           placeholder="Cari peserta..." class="form-control me-2" style="max-width: 250px;">
    <button type="submit" class="btn btn-primary">
  ...
  <div>
    ...
    <select name="sort_by" onchange="this.form.submit()" class="form-select d-inline-block" style="width:150px;">
        ...
        <option value="kecamatan" {{ request('sort_by')=='kecamatan'?'selected':'' }}>Kecamatan</option>
    </select>

    <select name="sort_order" onchange="this.form.submit()" class="form-select d-inline-block" style="width:130px;">
        ...
        <option value="desc" {{ request('sort_order')=='desc'?'selected':'' }}>Turun</option>
                        ...
                        <a href="{{ route('admin.peserta.create') }}" class="btn btn-primary">Tambah</a>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $peserta->subKegiatan->nama_subKegiatan ?? '-' }}</td>
                                        <td>{{ $peserta->nik }}</td>
                                        <td>{{ $peserta->no_kk }}</td>
                                        ...
                                        <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('admin.peserta.edit', $peserta->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                        <form action="{{ route('admin.peserta.destroy', $peserta->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                                            @csrf
                                                            @method('DELETE')
