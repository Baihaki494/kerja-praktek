...
<body>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="date" class="form-control" id="tanggal_mulai_kegiatan" name="tanggal_mulai_kegiatan"
                value="{{ old('tanggal_mulai_kegiatan', $kegiatan->tanggal_mulai_kegiatan) }}" required>
        </div>
        <div class="col-md-6 mb-3">
            <label for="tanggal_selesai_kegiatan" class="form-label">Tanggal Selesai</label>
            <input type="date" class="form-control" id="tanggal_selesai_kegiatan" name="tanggal_selesai_kegiatan"
                value="{{ old('tanggal_selesai_kegiatan', $kegiatan->tanggal_selesai_kegiatan) }}" required>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="time" class="form-control" id="jam_mulai_kegiatan" name="jam_mulai_kegiatan"
                value="{{ old('jam_mulai_kegiatan', $kegiatan->jam_mulai_kegiatan) }}" required>
        </div>
        <div class="col-md-6 mb-3">
            <label for="jam_selesai_kegiatan" class="form-label">Jam Selesai</label>
            <input type="time" class="form-control" id="jam_selesai_kegiatan" name="jam_selesai_kegiatan"
                value="{{ old('jam_selesai_kegiatan', $kegiatan->jam_selesai_kegiatan) }}" required>
        </div>
    </div>

    <div class="mb-3">
        <label for="deskripsi_kegiatan" class="form-label">Deskripsi</label>
        <textarea class="form-control" id="deskripsi_kegiatan" name="deskripsi_kegiatan" rows="3">{{ old('deskripsi_kegiatan', $kegiatan->deskripsi_kegiatan) }}</textarea>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" id="kuota_kegiatan" name="kuota_kegiatan"
                value="{{ old('kuota_kegiatan', $kegiatan->kuota_kegiatan) }}">
        </div>
        <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" id="limit_kuota_kegiatan" name="limit_kuota_kegiatan"
                value="{{ old('limit_kuota_kegiatan', $kegiatan->limit_kuota_kegiatan) }}">
        </div>
    </div>
    ...
    <div class="mb-3">
        ...
        <select name="status_kegiatan" id="status_kegiatan" class="form-control">
            <option value="1" {{ old('status_kegiatan', $kegiatan->status_kegiatan) == 1 ? 'selected' : '' }}>Aktif</option>
            <option value="0" {{ old('status_kegiatan', $kegiatan->status_kegiatan) == 0 ? 'selected' : '' }}>Tidak Aktif</option>
        </select>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="url" class="form-control" id="link_full_kegiatan" name="link_full_kegiatan"
            value="{{ old('link_full_kegiatan', $kegiatan->link_full_kegiatan) }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="url" class="form-control" id="link_short_kegiatan" name="link_short_kegiatan"
            value="{{ old('link_short_kegiatan', $kegiatan->link_short_kegiatan) }}">
    </div>
